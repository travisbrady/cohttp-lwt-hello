...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4f04cb8316863ff14f064bbe8e4b9e18) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "hello.ml"});
               Executable
                 ({
                     cs_name = "json_bench";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "json_bench.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "¢2No° \003\001uy^\023\137Ä\007\156";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
